...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        } else if (RomanNum.checkingRomanNum(num1) && RomanNum.checkingRomanNum(num2)) {
            int numRoman1 = RomanNum.romanToInt(num1);
            int numRoman2 = RomanNum.romanToInt(num2);
            int res = Operation.doingOperation(numRoman1, numRoman2, operation);
            if (res > 0) {
                System.out.println(RomanNum.intToRome(res));
            } else {
